...
const Questions: QuestionsType = {
  ...
  canIpay: {type: 'boolean' as const, required: false, title: 'Posso pagar sem comprometer o orçamento?', points: 2, defaultValue: false },
  ...
  willGenerateFutureCosts: {type: 'boolean' as const, required: false, title: 'Vai me gerar custos futuros (manutenção, acessórios, energia etc.)?', points: -2, defaultValue: false },
  stillWantIn30Days: {type: 'boolean' as const, required: false, title: 'Ainda vou querer isso daqui a 30 dias?', points: 2, defaultValue: false },
